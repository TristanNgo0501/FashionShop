...
<body>
    ...
    <div class="content">
        ...
        <div class="container">
            ...
            <h2 style="text-align:center; margin-top:1rem">Edit Blog</h2>
            ...
            <form method="post" onsubmit="return checkvalidate()"  enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" hidden name="id" value="{{ $ds["Id"] }}">
                            <input type="text" class="form-control" id="exampleInputBlogName"
                                aria-describedby="nameHelp" placeholder="Enter Blog Name"  name="exampleInputBlogName" value="{{ $ds["Name"] }}">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea type="text" rows="4" class="form-control" id="exampleInputDescription"
                                aria-describedby="descriptionHelp" placeholder="Enter Description" name="exampleInputDescription">{{ $ds["Description"] }}</textarea>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea type="text" rows="4" class="form-control ckeditor" id="exampleInputContent"
                                aria-describedby="descriptionContent" placeholder="Enter Content" name="exampleInputContent">{{ $ds["Content"] }}</textarea>
                ...
                <div class="row" id="div-image">
                    <div class="col-sm-2"></div>
                    <div class="col">
                        <img src="{{ asset("".$ds["Thumbnail"]) }}" id="imageavt" height="200px" />
                    </div>
